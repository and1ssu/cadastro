...
export default class FakerApi {
    ...
    routes = {
        '/login': function (instance: FakerApi, { username, password }: TFakerApi) {
        ...
        '/register': function (instance: FakerApi, { name, username, password }: TFakerApi) {
            if (!name || !username || !password) throw 'Dados invalidos'

            const users = instance._allUsers()
            if (users.filter((userMap: { username: string }) => userMap.username === username)[0]) throw 'Usuario já cadastrado'
        ...
        '/posts/view': function (instance: FakerApi, { post_id }: TFakerApi) {
            return {
                success: true,
                data: instance._getPost(post_id)
            }
        },
        '/posts/create': function (instance: FakerApi, { title, content }: TFakerApi) {
        ...
        '/posts/update': function (instance: FakerApi, { post_id, post: { title, content } }: TFakerApi) {
        ...
        '/posts/remove': function (instance: FakerApi, { post_id }: TFakerApi) {
        ...
        '/comments': function (instance: FakerApi, { post_id }: TFakerApi) {
            return {
                success: true,
                data: instance._getComments(post_id)
            }
        },
        '/comments/view': function (instance: FakerApi, { post_id, comment_id }: TFakerApi) {
            return {
                success: true,
                data: instance._getComment(post_id, comment_id)
            }
        },
        '/comments/create': function (instance: FakerApi, { post_id, comment: { content } }: TFakerApi) {
        ...
        '/comments/update': function (instance: FakerApi, { post_id, comment_id, comment: { content } }: TFakerApi) {
        ...
        '/comments/remove': function (instance: FakerApi, { post_id, comment_id }: TFakerApi) {
